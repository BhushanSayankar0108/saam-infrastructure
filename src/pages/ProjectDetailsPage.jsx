...
function getProjectSerialNumber(project) {
  const displayOrder =
...
function ProjectDetailsPage() {
  ...
  useEffect(() => {
    ...
    async function loadProject() {
      ...
      try {
        ...
        /*
         * Disabled projects should not be exposed
        ...
        const [
          ...
          fetch(
            `${PROJECTS_API}/${id}/features`
          ),
          fetch(
            `${PROJECTS_API}/${id}/progress-images/enabled`
          ),
        ]);
        ...
        /*
         * Preserve the exact shape the existing
         * ProjectDetails UI expects.
         */
        setProject({
          ...projectData,
          features,
        ...
        /*
         * Fallback to existing local project data
  ...
  if (loading) {
    /*
     * Keep this visually quiet so the finalized page
     * does not get redesigned while the CMS loads.
     */
    return (
          ...
          <div className="absolute left-0 top-0 w-full">
            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 sm:py-7 lg:px-8">
              ...
              <div className="hidden items-center gap-2 rounded-full border border-white/20 bg-black/25 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-white/80 backdrop-blur-md sm:flex">
                ...
                Project{" "}
                {getProjectSerialNumber(project)}
